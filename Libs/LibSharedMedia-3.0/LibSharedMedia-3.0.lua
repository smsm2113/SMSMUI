...
lib.MediaTable.background["Blizzard Garrison Background"]       = [[Interface\Garrison\GarrisoSMSMUIBackground]]
lib.MediaTable.background["Blizzard Garrison Background 2"]     = [[Interface\Garrison\GarrisoSMSMUIBackground2]]
lib.MediaTable.background["Blizzard Garrison Background 3"]     = [[Interface\Garrison\GarrisonMissioSMSMUIInfoBoxBackgroundTile]]
